 ...
 * @author Als
 */
public class GajiPerKaryawanReportForm extends javax.swing.JFrame {
...
//         isitable();
    ...
    private void initComponents() {
        ...
        gajiKaryawanTable = new javax.swing.JTable();
        ...
        gajiKaryawanTable.setAutoCreateRowSorter(true);
        gajiKaryawanTable.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        gajiKaryawanTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(gajiKaryawanTable);
        gajiKaryawanTable.getColumnModel().getColumn(0).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(0).setPreferredWidth(50);
        gajiKaryawanTable.getColumnModel().getColumn(1).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(1).setPreferredWidth(100);
        gajiKaryawanTable.getColumnModel().getColumn(2).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(2).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(3).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(3).setPreferredWidth(50);
        gajiKaryawanTable.getColumnModel().getColumn(4).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(4).setPreferredWidth(50);
        gajiKaryawanTable.getColumnModel().getColumn(5).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(5).setPreferredWidth(50);
        gajiKaryawanTable.getColumnModel().getColumn(6).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(6).setPreferredWidth(50);
        gajiKaryawanTable.getColumnModel().getColumn(7).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(7).setPreferredWidth(50);
        gajiKaryawanTable.getColumnModel().getColumn(8).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(8).setPreferredWidth(50);
        gajiKaryawanTable.getColumnModel().getColumn(9).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(9).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(10).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(10).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(11).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(11).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(12).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(12).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(13).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(13).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(14).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(14).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(15).setResizable(false);
        gajiKaryawanTable.getColumnModel().getColumn(15).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(16).setResizable(false);
        ...
        menuLabel.setText("Menu Cetak Report Gaji Per Karyawan");

        fungsiLabel.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        fungsiLabel.setText("Digunakan untuk mencetak gaji per karyawan per bulan");
...
//        } else {
    ...
    private javax.swing.JTable gajiKaryawanTable;
