...
public class PresensiTableModel extends AbstractTableModel {
    ...
    private List<RekapPresensi> detailPresensis = new ArrayList<RekapPresensi>();

    public PresensiTableModel(List<RekapPresensi> detailPresensis) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        RekapPresensi dP=detailPresensis.get(rowIndex);
        switch (columnIndex) {
            case 0:
                return dP.getNo();
            case 1:
