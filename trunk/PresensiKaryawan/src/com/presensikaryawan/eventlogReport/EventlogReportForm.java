 ...
 * @author Als
 */
public class EventlogReportForm extends javax.swing.JFrame {
     ...
     */
    public EventlogReportForm(final JFrame frame, final JMenuItem menuItem) throws SQLException {
        initComponents();
...
//         isitable();
    ...
    private void initComponents() {
        ...
        eventlogTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NO", "NIP", "NAMA", "NUM CARD", "DATELOG", "TIMELOG", "VERIFY", "FKMODE", "DEVICE ID"
            }
        ) {
        ...
        eventlogTable.getColumnModel().getColumn(3).setPreferredWidth(100);
        eventlogTable.getColumnModel().getColumn(4).setResizable(false);
        eventlogTable.getColumnModel().getColumn(4).setPreferredWidth(120);
        eventlogTable.getColumnModel().getColumn(5).setResizable(false);
        eventlogTable.getColumnModel().getColumn(5).setPreferredWidth(120);
        eventlogTable.getColumnModel().getColumn(6).setResizable(false);
        eventlogTable.getColumnModel().getColumn(6).setPreferredWidth(70);
        eventlogTable.getColumnModel().getColumn(7).setResizable(false);
        eventlogTable.getColumnModel().getColumn(7).setPreferredWidth(70);
        eventlogTable.getColumnModel().getColumn(8).setResizable(false);
        eventlogTable.getColumnModel().getColumn(8).setPreferredWidth(100);
...
private void lihatButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lihatButtonActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new EventlogReportForm(null, null).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(EventlogReportForm.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
