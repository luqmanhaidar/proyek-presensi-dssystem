...
//         isitable();
        initComponentFocus();
        gajiKaryawanTable.getColumnModel().getColumn(0).setPreferredWidth(70);
        gajiKaryawanTable.getColumnModel().getColumn(1).setPreferredWidth(150);
        gajiKaryawanTable.getColumnModel().getColumn(2).setPreferredWidth(200);
        gajiKaryawanTable.getColumnModel().getColumn(3).setPreferredWidth(70);
        gajiKaryawanTable.getColumnModel().getColumn(4).setPreferredWidth(70);
        gajiKaryawanTable.getColumnModel().getColumn(5).setPreferredWidth(70);
        gajiKaryawanTable.getColumnModel().getColumn(6).setPreferredWidth(70);
        gajiKaryawanTable.getColumnModel().getColumn(7).setPreferredWidth(70);
        gajiKaryawanTable.getColumnModel().getColumn(8).setPreferredWidth(70);
