 ...
 * @author Tinus
 */
public class TransaksiGajiDepartmentReport {
    ...
    public TransaksiGajiDepartmentReport() {
    }
    ...
    /**
     * @return the potonganLain
     */
    public double getPotonganLain() {
        return potonganLain;
    }

    /**
     * @param potonganLain the potonganLain to set
     */
