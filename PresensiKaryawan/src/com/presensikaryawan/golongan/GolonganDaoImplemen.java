...
public class GolonganDaoImplemen implements GolonganDao{
    ...
    private final String SQL_INSERT = "insert into golongan(kode_golongan,nama_golongan) values (?,?)";
    private final String SQL_UPDATE = "update golongan set nama_golongan = ? where kode_golongan = ?";
    ...
    public void update(Golongan golongan) throws SQLException {
        PreparedStatement statement = null;
         try {
             ...
             statement.setString(2,golongan.getKodeGolongan());
             statement.executeUpdate();
